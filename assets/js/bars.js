...
// document.getElementById("x-post").classList.add("tweet-style");



  // $("#menu").click(function(){
  //     document.getElementById("bgvid").setAttribute('autoplay', true);
  //     document.getElementById("bgvid").play();
  //     $('#supersized-loader').css('background', 'rgb(54 49 49 / 47%)');
  // });
